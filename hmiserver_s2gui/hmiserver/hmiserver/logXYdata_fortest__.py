...
#	print x
	...
	head = HBClient1.GetInputRegistersInt(18)
	print head
	file.write( str(valVF) + '\t' + str(valVL) + '\n' )
	time.sleep(0.5)
...
#	if x % 7 is 0:
	...
	VF_Delta = 1000*math.sin(math.radians(head))
	VL_Detla = 1000*math.cos(math.radians(head))
	file2 = open("truckHeading.dat","w")
	file2.write( str(valVF) + '\t' + str(valVL) + '\t' + str(VF_Delta) + '\t' + str(VL_Detla) + '\n' )
	file2.close()
