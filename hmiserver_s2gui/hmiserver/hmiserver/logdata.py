...
file = open("encoder10.txt","w")
with open("encoder.txt","w") as file:
	while True:
		val10 = HBClient1.GetInputRegistersIntList(10,2)
		val12 = HBClient1.GetInputRegistersIntList(12,2)	
		file.write( "Addr10" + str(val10) + "Addr12" + str(val12) + '\n' )
		time.sleep(0.5)
		print "Here"
print "Here2"
